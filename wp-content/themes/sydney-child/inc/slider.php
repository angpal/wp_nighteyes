...
function sydney_slider_template() {
    ...
    if ( !function_exists('pll_register_string') ) {
        $slider_title_1     = get_theme_mod('slider_title_1', 'Enjoy the outdoors with Night Eyes');
                ...
                if ( get_theme_mod('slider_image_1', get_template_directory_uri() . '/images/1.png') ) {
                    ...
                    ?>
                        <div class="slide-inner">
                            ...
                            <?php child_sydney_slider_button(); ?>
                        </div>
                    <?php
                    echo '</div>';
...
function child_sydney_slider_button() {
...
function child_sydney_stop_text() {
